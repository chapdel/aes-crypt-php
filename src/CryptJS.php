...
class CryptJS
{
     ...
     * @return string
     */
    public static function encrypt($value, string $passphrase = 'aes-256-cbc')
    {
     ...
     * @return mixed
     */
    public static function decrypt(string $jsonStr, string $passphrase = 'aes-256-cbc')
    {
